...
- [ ] **Step 1: Verify the backup and source boundary**
...
- [ ] **Step 2: Copy the source into a new staging directory**
...
- [ ] **Step 3: Consolidate parent-owned Loom docs**
...
- [ ] **Step 4: Add the standalone layout contract**
...
- [ ] **Step 5: Run the layout contract and record the expected red state**
...
- [ ] **Step 1: Add standalone repository metadata**
...
- [ ] **Step 3: Update package/repository links**
...
- [ ] **Step 4: Remove the hard-coded desktop release fallback**
...
- [ ] **Step 1: Write a failing standalone release contract**
...
- [ ] **Step 3: Extract the Loom-only build script**
...
- [ ] **Step 4: Extract the Loom-only verifier**
...
- [ ] **Step 5: Extract the Loom-only unified smoke**
...
- [ ] **Step 6: Run the release contract and builder dry run**
...
- [ ] **Step 1: Write and run the failing workflow contract**
...
- [ ] **Step 2: Build and smoke a standalone candidate**
...
- [ ] **Step 4: Validate a second clean clone**
...
- [ ] **Step 1: Verify safe authentication**
...
- [ ] **Step 2: Recheck repository absence**
...
- [ ] **Step 4: Verify Actions registration**
...
- [ ] **Step 1: Verify the published commit and backup**

Record the remote commit ID. Recheck the backup and ensure no process runs from
the live Loom path.

- [ ] **Step 2: Preserve the live directory without deleting it**
...
- [ ] **Step 3: Replace the parent index entry**
...
- [ ] **Step 4: Consolidate parent docs and wrapper**
...
- [ ] **Step 1: Verify the parent gitlink and clean clone**
...
- [ ] **Step 2: Re-run standalone CI-equivalent gates**
...
- [ ] **Step 4: Update migration/progress documentation**
